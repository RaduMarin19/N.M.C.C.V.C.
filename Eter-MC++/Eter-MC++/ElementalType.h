...
enum class ElementalType {
    ...
    LAVA,                 // Lava: Toate cartile vizibile cu un numar specific se intorc in mainile proprietarilor.
    ...
    SQUALL,               // Vijelie: Toate cartile acoperite de alte carti se intorc in mainile proprietarilor.
    ...
    STORM,                // Furtuna: Elimina din joc orice teanc de carti ce contine 2 sau mai multe carti.
    ...
    SUPPORT,              // Sprijin: Valoarea unei carti proprii 1/2/3 creste cu 1.
    EARTHQUAKE,           // Cutremur: Elimina de pe tabla toate cartile vizibile cu numarul 1.
    SHATTER,              // Sfarama: Valoarea unei carti a adversarului 2/3/4 scade cu 1.
    ...
    BOULDER               // Bolovan: Acopera orice iluzie cu o carte, fara a intoarce iluzia.
};
